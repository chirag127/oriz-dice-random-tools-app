---
type: index
title: "oriz-dice-random-tools-app — knowledge bundle"
description: "App-specific knowledge for oriz-dice-random-tools-app. Cross-cutting family rules live at master `c:/D/oriz/knowledge/`."
tags: [okf, index, app, dice-random-tools]
timestamp: 2026-06-21
format_version: okf-v0.1
status: active
---

# oriz-dice-random-tools-app — knowledge bundle

This is the per-app OKF-light bundle for **oriz-dice-random-tools-app**. App-specific facts only. Cross-cutting family rules / decisions / services live at master [`../../../../knowledge/`](../../../../knowledge/).
...
- **Category**: tools
- **Family role**: Browser-based random + picker tools under the Dice product brand.
